...
class FirebaseService:
    ...
    # REFACTORED CODE EXAMPLE
    def create_firebase_document(self, user_email, recipe_info, type):
        """
        This function creates and stores a new grocery in a Cloud Firestore Database base on the type variable
        Params :
    ...
    # REFACTORED CODE EXAMPLE
    def fetch_items(self, type):
        if type == "groceries":
            items = [doc.to_dict() for doc in self.groceries_ref.stream()]
        elif type == "recipes":
            items = [doc.to_dict() for doc in self.recipes_ref.stream()]
        return items
    ...
    def recipe_check(self, recipe_name):
        ...
        recipes = self.fetch_items("recipes")
    ...
    def grocery_check(self, grocery_name):
        ...
        groceries = self.fetch_items("groceries")
    ...
    # REFACTORED CODE EXAMPLE 
    def fetch_user_items(self, user_email, type):
        """
